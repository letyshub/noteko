...
describe('IPC_CHANNELS', () => {
  it('should have the expected number of channel entries', () => {
    ...
    // ping + 5 projects + 4 folders + 6 documents + 4 quizzes + 2 quiz-attempts + 4 dashboard + 4 quiz-history + 3 files + 1 file-export + 2 parsing + 7 ai (6+1 chat) + 4 chat-db + 3 settings + 4 logs + 1 csv-export + 1 progress + 5 search + 10 tags + 2 app = 73
    expect(channelKeys).toHaveLength(73)
  })
